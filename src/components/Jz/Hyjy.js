  ...
  render() {
    ...
    return (
       <div className="bj">
         ...
         <iframe src="http://likeyou.x9.fjjsp01.com/youku/videoyk.jsp?token=v&width=620&height=400&auto=no&id=XMTQ5MTc2ODQ1Ng" width="100%" height="200" scrolling="no" style={{border: 0,marginBottom: 50}}></iframe>
